...
| [Area Picker](addons/area-picker@beatlink/) | widget | A right pane dropdown widget that allows you set a note to a specific area of life | 2.1.0 |
...
| [Form Number](addons/libformnumber@beatlink/) | library | Reusable Preact number-input component for TriliumNext widget UIs. | 1.1.0 |
...
| [Recurrence](addons/librecurrence@beatlink/) | library | Converts between an RRULE string and a plain object shaped for a recurrence-picker UI, on top of the vendored rrule.js library. | 1.2.0 |
...
| [Workflow](addons/workflow@beatlink/) | widget | An opinionated GTD-style knowledgebase and task system: a single Workflow window with Collect / Organize / Review / Execute tabs, built on top of the Agenda and Templates addons. | 0.4.0 |
<!-- GENERATED:END -->
