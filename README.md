...
| [Form Controls](addons/libformcontrols@beatlink/) | library | A curated color-swatch picker with a custom CSS-color fallback, as a reusable Preact component for TriliumNext widget UIs. Controls that Trilium&#x27;s own trilium:preact provides are not duplicated here. | 1.6.0 |
